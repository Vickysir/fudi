...
// 注册  获取手机验证码
export const APIRegistPhoneVerificationCode = async (
  params: PhoneVerificationCodePost
) => {
  return await axios.post<VerificationCodePostResponse>(
    apiPath.registPhoneVerificationCode,
    params
  );
};
// 更新手机号  获取手机验证码
export const APIUpdatePhoneVerificationCode = async (
  params: PhoneVerificationCodePost
) => {
  return await axios.post<VerificationCodePostResponse>(
    apiPath.updatePhoneVerificationCode,
    params
  );
};
// 注册
...
// 忘记密码  获取邮箱code
export const APIEmailVerificationCode = async (
  params: EmailVerificationCodePost
) => {
  return await axios.post<VerificationCodePostResponse>(
    apiPath.emailVerificationCode,
    params
  );
};
// 忘记密码  修改密码
...
export const APIShopServicePhone = async (shopId: number) => {
  return await axios.post<ShopServicePhoneResponse>(apiPath.shopServicePhone, {
    shopId,
  });
};
...
export const APISettingPageInfo = async () => {
  return await axios.post<SettingPageInfoPostResponse>(
    apiPath.personalCenterInfo
  );
};
// 个人中心 send 建议
...
// 个人中心 修改密码
export const APIPersonalCenterUpdatePassword = async (
  params: PersonalCenterUpdatePasswordPost
) => {
...
export const APIPersonalCenterInvitation = async () => {
  return await axios.post<PersonalCenterInvitationPost>(
    apiPath.personalCenterInvitation
  );
};
// 个人中心 my order
export const APIPersonalCenterOrderList = async (
  params: PersonalCenterOrderListPost
) => {
...
export const APIPersonalCenterCouponList = async (
  ...
  return await axios.post<PersonalCenterCouponListPostResponseArray[]>(
    apiPath.personalCenterCouponList,
    params
  );
};
...
// 个人中心 添加优惠券
export const APIPersonalCenterObtainCoupon = async (
  params: PersonalCenterObtainCouponPost
) => {
...
// 个人中心 上传头像
export const APIPersonalCenterUpdateIcon = async (
  params: PersonalCenterUpdateIconPost
) => {
  return await axios.post(apiPath.personalCenterUpdateIcon, params);
};

// 个人中心 修改信息  Nickname
export const APIPersonalCenterUpdateNickname = async (param: {
  nickname: string;
}) => {
  return await axios.post(apiPath.personalCenterUpdateNickname, param);
};
// 个人中心 修改信息  Email
export const APIPersonalCenterUpdateEmail = async (
  params: EmailVerificationCodePost
) => {
...
export const APIPersonalCenterUpdatePhone = async (
  params: PersonalCenterUpdatePhonePost
) => {
...
// 首页搜索
export const APIShopInRange = async (params: {
  latitude: number;
  longitude: number;
}) => {
...
export const APITranslatePlaceIdToLocation = async (place_id: string) => {
  return fetch(
    `https://maps.googleapis.com/maps/api/geocode/json?place_id=${place_id}&key=AIzaSyDU8SBtzx84CB2gf2kfZhC_Y9BRP6U7znw`
  );
};
// 商铺shop详情
...
export const APIShopCategoriesLevelOne = async (params: { shopId: number }) => {
  return await axios.post<ShopCategoriesLevelOneResponseArray[]>(
    apiPath.categoriesInHomePages,
    params
  );
};
// 获取shop所有分类及商品
export const APIShopGoodsListAll = async (params: { shopId: number }) => {
  return await axios.post<ShopGoodsListAllResponseArray[]>(
    apiPath.shopGoodsListAll,
    params
  );
};
// shop页面 搜索
export const APIGoodsSearch = async (params: {
  shopId: number;
  title: string;
...
//remove 购物车
export const APIRemoveCartList = async (params: {
  shopId: number;
  id: number;
}) => {
...
export const APIPaymentOnlineCheck = async (params: { userOrderId: number | string }) => {
