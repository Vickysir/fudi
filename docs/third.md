        ...
        - 时间
            - delivery
                ...
                - 选择指定的时间,[规则参考](https://github.com/Vickysir/fudi/issues/41)   
                    - 当前时间10：30，时间的可选择范围是否在营业区间内
                    - 当前时间15：30，时间的可选择范围是否在营业区间内
                    - 当前时间16：30，时间的可选择范围是否在营业区间内
                    - 当前时间18：09，时间的可选择范围是否在营业区间内 ✅
                    - 当前时间21：30，时间的可选择范围是否在营业区间内 ✅
                    - 当前时间23：30，时间的可选择范围是否在营业区间内 
            - coloction
                - 时间选择上是否和delivery一致，目前是一致的 ❓❓❓
        ...
        - 支付
            ...
            - coloction
                ...
                - card
                    ...
                    - 如果在支付页面返回？此时订单已生成，再点击下单，将再次下单，再次进入支付页面
                    - 如果用户在生成订单后，却没有进行支付，将在何处继续进行支付？
    - 使用优惠券
        - 优惠券列表可使用优惠券 ✅
        - 优惠券的id获取是否正确 ✅
